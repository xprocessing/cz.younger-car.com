<div class="row mt-4">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo ADMIN_PANEL_URL; ?>/roles.php?action=create" method="POST">
                    <div class="mb-3">
                                        ...
                                        <?php foreach ($modulePermissions as $permission): ?>
                                            <div class="col-md-4">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="permission_<?php echo $permission['id']; ?>" name="permissions[]" value="<?php echo $permission['id']; ?>">
