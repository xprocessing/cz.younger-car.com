...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo ADMIN_PANEL_URL; ?>/inventory_details.php?action=create_post">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
