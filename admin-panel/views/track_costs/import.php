...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo ADMIN_PANEL_URL; ?>/track_costs.php?action=import_post" 
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    <ul class="mb-0">
                        ...
                        <li>记录数量：不超过1000条</li>
                        <li>第一行为表头，将被跳过</li>
                        <li>同一赛道、日期、费用类型的记录将被视为重复，导入时会跳过</li>
                    </ul>
                </div>
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ol class="list-unstyled">
                    <li><strong>赛道名称</strong> - track_name</li>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <h6>CSV示例</h6>
                <pre class="bg-light p-2 rounded small"><code>赛道名称,费用金额,费用类型,费用日期,备注
赛道A,299.50,仓库费用,2024-01-15,仓库租金
赛道B,149.75,人员工资,2024-01-15,员工工资
赛道C,89.99,其他费用,2024-01-15,办公耗材</code></pre>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <div class="mb-2">
                    <a href="<?php echo ADMIN_PANEL_URL; ?>/track_costs.php?action=create" class="btn btn-sm btn-outline-info w-100">
                        <i class="fa fa-plus"></i> 手动添加记录
                    </a>
                </div>
                <div class="mb-2">
                    <a href="<?php echo ADMIN_PANEL_URL; ?>/track_costs.php" class="btn btn-sm btn-outline-secondary w-100">
...
function downloadTemplate() {
    const csvContent = `赛道名称,费用金额,费用类型,费用日期,备注
赛道A,299.50,仓库费用,2024-01-15,仓库租金
赛道B,149.75,人员工资,2024-01-15,员工工资
赛道C,89.99,其他费用,2024-01-15,办公耗材`;
    
    const blob = new Blob([csvContent], { type: 'text/csv;charset=utf-8;' });
    const link = document.createElement('a');
    const url = URL.createObjectURL(blob);
    link.setAttribute('href', url);
    link.setAttribute('download', 'track_costs_template.csv');
...
document.querySelectorAll('form').forEach(function(form) {
    form.addEventListener('submit', function(e) {
        ...
        if (!confirm('确定要开始导入吗？请确保文件格式正确，且数据符合要求。')) {
            e.preventDefault();
            return;
        }
    });
