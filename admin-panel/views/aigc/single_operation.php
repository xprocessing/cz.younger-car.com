...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">图片处理操作</h6>
        </div>
        <div class="card-body">
            <form action="<?php echo APP_URL; ?>/aigc.php?action=processImages" method="POST" enctype="multipart/form-data">
                <!-- 任务类型选择 -->
                <div class="form-group">
                    <label for="task_type">选择处理类型</label>
                    <select class="form-control" id="task_type" name="process_types[]" required>
                        <option value="">请选择处理类型</option>
                        <option value="remove_defect">批量去瑕疵</option>
                        <option value="crop_png">批量抠图(PNG)</option>
                        <option value="crop_white_bg">批量抠图(白底)</option>
                        <option value="resize">批量改尺寸</option>
                        <option value="watermark">批量打水印</option>
                        <option value="face_swap">智能换脸</option>
                        <option value="multi_angle">多角度图片</option>
