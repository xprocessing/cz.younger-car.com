...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ol class="list-unstyled">
                    ...
                    <li><strong>日店铺花费</strong> - cost</li>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <h6>CSV示例</h6>
                <pre class="bg-light p-2 rounded small"><code>平台名称,店铺名称,日店铺花费,费用类型,费用日期,备注
Amazon-FBA,Shop001,299.50,店铺费用,2024-01-15,亚马逊店铺推广
eBay,Shop002,149.75,店铺费用,2024-01-15,eBay促销活动
Shopify,Shop003,89.99,店铺费用,2024-01-15,Shopify店铺推广</code></pre>
...
document.getElementById('excel_file').addEventListener('change', function(e) {
    ...
    reader.onload = function(e) {
        ...
        if (headerColumns !== 6) {
            alert('文件格式不正确，应有6列，实际有 ' + headerColumns + ' 列');
            e.target.value = '';
            return;
        }
    };
