            ...
            <div class="card-body">
                <form action="<?php echo ADMIN_PANEL_URL; ?>/permissions.php?action=edit&id=<?php echo $permission['id']; ?>" method="POST">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name" value="<?php echo $permission['name']; ?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="slug" class="form-label">权限标识</label>
                                <input type="text" class="form-control" id="slug" name="slug" value="<?php echo $permission['slug']; ?>" required placeholder="例如：users.view">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="module" name="module" required>
                                    ...
                                    <option value="users" <?php echo $permission['module'] == 'users' ? 'selected' : ''; ?>>用户管理</option>
                                    <option value="roles" <?php echo $permission['module'] == 'roles' ? 'selected' : ''; ?>>角色管理</option>
                                    <option value="permissions" <?php echo $permission['module'] == 'permissions' ? 'selected' : ''; ?>>权限管理</option>
                                    <option value="data" <?php echo $permission['module'] == 'data' ? 'selected' : ''; ?>>数据管理</option>
                                    <option value="yunfei" <?php echo $permission['module'] == 'yunfei' ? 'selected' : ''; ?>>运费管理</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="3"><?php echo $permission['description']; ?></textarea>
                    </div>
