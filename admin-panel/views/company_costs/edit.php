...
<div class="card">
    <div class="card-body">
        <form method="POST" action="<?php echo ADMIN_PANEL_URL; ?>/company_costs.php?action=edit_post">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="cost_type" name="cost_type" required>
                    ...
                    <option value="网络通信费" <?php echo ($cost['cost_type'] == '网络通信费' ? 'selected' : ''); ?>>网络通信费</option>
                    <option value="软件订阅/系统服务费" <?php echo ($cost['cost_type'] == '软件订阅/系统服务费' ? 'selected' : ''); ?>>软件订阅/系统服务费</option>
