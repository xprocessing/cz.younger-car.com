...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo ADMIN_PANEL_URL; ?>/order_profit.php?action=import_post" 
...
STORE001,ORDER2024003,美国,2024-01-15 14:20:00,SKU003,599.00,279.00,46.58,315.00,45.00</code></pre>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <div class="mb-2">
                    <a href="<?php echo ADMIN_PANEL_URL; ?>/order_profit.php?action=create" class="btn btn-sm btn-outline-info w-100">
                        <i class="fa fa-plus"></i> 手动添加记录
                    </a>
                </div>
                <div class="mb-2">
                    <a href="<?php echo ADMIN_PANEL_URL; ?>/order_profit.php?action=stats" class="btn btn-sm btn-outline-success w-100">
                        <i class="fa fa-bar-chart"></i> 查看利润统计
                    </a>
                </div>
                <div class="mb-2">
                    <a href="<?php echo ADMIN_PANEL_URL; ?>/order_profit.php" class="btn btn-sm btn-outline-secondary w-100">
