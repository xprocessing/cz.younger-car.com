<div class="d-flex justify-content-between align-items-center mb-3">
    <h4>编辑店铺</h4>
    <div>
        <a href="<?php echo ADMIN_PANEL_URL; ?>/store.php" class="btn btn-secondary">
...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo ADMIN_PANEL_URL; ?>/store.php?action=edit_post">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="store_manager_name" name="store_manager_name"
                                       value="<?php echo htmlspecialchars($store['store_manager_name'] ?? ''); ?>"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="track_manager_name" name="track_manager_name"
                                       value="<?php echo htmlspecialchars($store['track_manager_name'] ?? ''); ?>"
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="track_name" name="track_name"
                                       value="<?php echo htmlspecialchars($store['track_name'] ?? ''); ?>"
                    ...
                    <div class="mt-4">
                        ...
                        <a href="<?php echo ADMIN_PANEL_URL; ?>/store.php" class="btn btn-outline-secondary ms-2">
