...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo ADMIN_PANEL_URL; ?>/order_other_costs.php?action=import_post" 
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    <ul class="mb-0">
                        ...
                        <li>记录数量：不超过1000条</li>
                        <li>第一行为表头，将被跳过</li>
                        <li>费用日期格式：YYYY-MM-DD（如2024-01-15）</li>
                        <li>费用金额支持正数和负数（如-29.99表示退款）</li>
                    </ul>
                </div>
                ...
                <div class="alert alert-warning">
                    ...
                    <ul class="mb-0">
                        <li>导入前请备份现有数据</li>
                        <li>请检查文件格式是否符合要求</li>
                        <li>金额字段请使用数字格式，如：29.99或-29.99</li>
                        <li>平台名称和店铺名称必须正确填写</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ol class="list-unstyled">
                    ...
                    <li><strong>订单号</strong> - order_id</li>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <h6>CSV示例</h6>
                <pre class="bg-light p-2 rounded small"><code>费用日期,订单号,平台名称,店铺名称,费用类型,费用金额,备注
2024-01-15,ORDER-001,Amazon-FBA,Shop001,退货运费,29.99,客户退货
2024-01-15,ORDER-002,eBay,Shop002,运费补收,5.00,超重费
2024-01-15,ORDER-003,Shopify,Shop003,运输索赔,-50.00,物流赔偿
2024-01-15,ORDER-004,Amazon,Shop004,其他费用,10.00,包装费</code></pre>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <div class="mb-2">
                    <a href="<?php echo ADMIN_PANEL_URL; ?>/order_other_costs.php?action=create" class="btn btn-sm btn-outline-info w-100">
                        <i class="fa fa-plus"></i> 手动添加记录
                    </a>
                </div>
                <div class="mb-2">
                    <a href="<?php echo ADMIN_PANEL_URL; ?>/order_other_costs.php" class="btn btn-sm btn-outline-secondary w-100">
...
<script>
    ...
    function downloadTemplate() {
        const csvContent = "data:text/csv;charset=utf-8," + 
                           "费用日期,订单号,平台名称,店铺名称,费用类型,费用金额,备注\n" +
                           "2024-01-15,ORDER-001,Amazon-FBA,Shop001,退货运费,29.99,客户退货\n" +
                           "2024-01-15,ORDER-002,eBay,Shop002,运费补收,5.00,超重费\n" +
                           "2024-01-15,ORDER-003,Shopify,Shop003,运输索赔,-50.00,物流赔偿\n" +
                           "2024-01-15,ORDER-004,Amazon,Shop004,其他费用,10.00,包装费\n";
        
        const encodedUri = encodeURI(csvContent);
        const link = document.createElement("a");
        link.setAttribute("href", encodedUri);
        link.setAttribute("download", "order_other_costs_template.csv");
