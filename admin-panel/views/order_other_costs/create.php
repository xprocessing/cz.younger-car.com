...
<div class="card">
    <div class="card-body">
        <form method="POST" action="<?php echo ADMIN_PANEL_URL; ?>/order_other_costs.php?action=create_post">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="cost_type" name="cost_type" required>
                    ...
                    <option value="退货运费">退货运费</option>
                    <option value="运费补收">运费补收</option>
                    <option value="运输索赔">运输索赔</option>
