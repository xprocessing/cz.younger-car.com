...
$emsWarehouseCodes = "USWE,USEA"; // 中邮仓库编码（USWE：美国西部仓，USEA：美国东部仓）
$emsChannelCodes = "FEDEX-GROUND-EA,SS-FEDEX-G-E,FEDEX-SM,FEDEX-LP,AMAZON-GROUND,USPS-FIRST-CLASS,USPS-PRIORITY,DHL-US-SP,DHL-US-BP,YUN-GROUND,CE-PARCEL,CE-GROUND-EA,UPS-GROUND-EA,UPS-GROUND-MULT,UPS-SUREPOST,UPS-2ND-DAY"; // 中邮渠道编码
...
echo '<table>';
echo '<thead><tr>
<th>仓库编码</th><th>物流渠道</th><th>总费用 (CNY)</th><th>请求状态</th><th>错误码</th><th>错误信息</th>
</tr></thead><tbody>';
...
// 渲染表格（优化：表格列名更清晰）
echo '<table><thead><tr>
<th>#</th><th>物流渠道</th><th>费用 (CNY)</th><th>原币种</th>
</tr></thead><tbody>';
