...
# 通过sku获取中邮的产品规格 http://cz.younger-car.com/yunfei_kucun/api_ems/getProductList.php?page=1&pageSize=10&product_sku=YOUR_SKU_001

# 通过sku获取运德的产品规格

# 获取中邮运费试算api https://cz.younger-car.com/yunfei_kucun/api_ems/ems_api6.php?postcode=90210&weight=1.5&warehouse=USEA,USWE&channel=USPS-PRIORITY,AMAZON-GROUND
# 获取运德的运费试算 
